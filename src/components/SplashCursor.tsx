...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement): any {
      const params = {
        alpha: true,
        depth: false,
        stencil: false,
    ...
    function clickSplat(pointer: any) {
      ...
      color.r *= 4.0; // dialed down to 40% of original 10.0
      color.g *= 4.0;
      color.b *= 4.0;
      let dx = 4 * (Math.random() - 0.5);
      let dy = 12 * (Math.random() - 0.5);
    ...
    function hexToRGB(hex: string) {
      ...
      // Scaled to 40% of original 0.15 intensity (0.06)
      return { r: r * 0.06, g: g * 0.06, b: b * 0.06 };
    }
