...
const Cubes = ({
  ...
  const colGap =
    typeof cellGap === 'number'
      ? `${cellGap}px`
      : (cellGap as CubesCellGap)?.col !== undefined
      ? `${(cellGap as CubesCellGap).col}px`
      : '5%';
  const rowGap =
    typeof cellGap === 'number'
      ? `${cellGap}px`
      : (cellGap as CubesCellGap)?.row !== undefined
      ? `${(cellGap as CubesCellGap).row}px`
      : '5%';
